...
pub const COMPLETION_ATTEMPT_SCHEMA: &str = "mitase/completion-attempt/v1";
pub const FINALIZATION_RECEIPT_SCHEMA: &str = "mitase/finalization-receipt/v1";
pub const AGENT_RUN_SCHEMA: &str = "mitase/agent-run/v1";
pub const AGENT_PATCH_SCHEMA: &str = "mitase/agent-patch/v1";
pub const AGENT_EVENT_SCHEMA: &str = "mitase/agent-event/v1";
pub const AGENT_CONTEXT_SCHEMA: &str = "mitase/agent-context/v1";
pub const WORK_ORIGIN_CAPABILITY_SCHEMA: &str = "mitase/work-origin-capability/v1";
pub const WORK_SELECT_SLICE_SCHEMA: &str = "mitase/work-select-slice/v1";
pub const WORK_SELECT_SLICE_RESPONSE_SCHEMA: &str = "mitase/work-select-slice-response/v1";
pub const WORK_ERROR_SCHEMA: &str = "mitase/work-error/v1";
pub const WORK_SPLIT_RECOVERY_SCHEMA: &str = "mitase/work-split-recovery/v1";
pub const WORK_EXECUTION_IDENTITY_DIGEST_DOMAIN: &str =
    "mitase/work-execution-identity-digest/v1\0";
pub const VERIFICATION_RECEIPT_DIGEST_DOMAIN: &str = "mitase/verification-receipt-digest/v1\0";
pub const FINALIZATION_RECEIPT_DIGEST_DOMAIN: &str = "mitase/finalization-receipt-digest/v1\0";
...
pub fn work_plan_digest(plan: &WorkPlan) -> String {
    ...
    let mut hash = Sha256::new();
    hash.update(b"mitase/work-plan-digest/v1\0");
    hash.update(bytes);
    format_sha256(hash.finalize())
}
...
mod tests {
    ...
    fn canonical_digest_domains_have_literal_vectors() {
        ...
        assert_eq!(
            ...
            "sha256:54dfe5969f459631cbf4736c0e523a7999649a42765b8990062aed83e812cc6f"
        );
    }
}
