  ...
  const response = await fetch(url, {
    ...
    headers: {
      ...
      ...(csrfToken && method !== 'GET'
        ? { 'x-mitase-csrf-token': csrfToken }
        : {}),
      ...(options.headers || {}),
    },
  });
  const receivedToken = response.headers?.get?.('x-mitase-csrf-token');
...
export const workOriginCapabilitySchema = 'mitase/work-origin-capability/v1';
export const workSelectSliceSchema = 'mitase/work-select-slice/v1';
