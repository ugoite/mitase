export function createState(projection) {
  return {
    ...
    // undefined means the Work route has not hydrated this render yet;
    // null is an explicit URL state that clears the previous context.
    journeyRouteItemId: undefined,
    ...
    journeyCreatedSpecification: null,
    journeyAuthoringNotice: null,
    journeyTargetSuggestionsLoading: false,
