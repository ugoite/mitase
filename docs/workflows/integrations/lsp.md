...
- Use [getting started](../../start-here/first-run/getting-started.md) when you still need the normal
  install / init / validate path before wiring editor integrations.
- Use [troubleshooting](../repository/troubleshooting.md) for broader validation and
