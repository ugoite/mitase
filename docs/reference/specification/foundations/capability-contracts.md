...
- **id**: REQ-CAPABILITY-001
  ...
  - **bindings**:
    - **id**: core-verification
      ...
      - **responsibility**: Verify core specification, configuration, inventory, identity, index, ownership, readiness, change, and contract behavior.
      - **targets**:
        - **id**: spec-model-test
          - **adapter**: rust
        ...
        - **id**: target-lifecycle-test
          ...
          - **claims**:
            - **kind**: verifies
              - **criterion**: REQ-CAPABILITY-001#criterion.spec-model
              - **covers**:
                - FEAT-SPEC-MODEL-001#binding.implementation/target.target-lifecycle
              - **runner**:
                - **runner**: cargo-test
                - **arguments**:
                  - **package**: mitase-spec-model
...
- **id**: REQ-CAPABILITY-002
  ...
  - **bindings**:
    - **id**: dependency-verification
      - **role**: verification
      - **facet**: capability-verification
      - **responsibility**: Verify language-aware inventory, stable identity, contract closure, and semantic change classification.
      - **targets**:
