    ...
    - **id**: detail-verification
      ...
      - **targets**:
        ...
        - **id**: detail-browser-test
          ...
          - **selector**:
            - **kind**: symbol
            - **name**: tests::workbench_http_projection_readiness_and_esm_flow
          - **claims**:
            - **kind**: verifies
              - **criterion**: REQ-WORKBENCH-015#criterion.declaration-runtime-evidence
              - **covers**:
              ...
              - **runner**:
                ...
                - **arguments**:
                  - **package**: syu-workbench-server
                  - **test**: tests::workbench_http_projection_readiness_and_esm_flow
            - **kind**: verifies
              - **criterion**: REQ-WORKBENCH-015#criterion.canonical-detail-trace
              - **covers**:
                - FEAT-WORKBENCH-SPEC-DETAIL-001#binding.detail-workspace/target.detail-browser-workspace
...
- id: FEAT-WORKBENCH-SPEC-DETAIL-001
  ...
  - id: detail-verification
    ...
    - id: detail-browser-test
      adapter: rust
      path: crates/syu-workbench-server/src/lib.rs
      selector: { kind: symbol, name: tests::workbench_http_projection_readiness_and_esm_flow }
      claims:
      - kind: verifies
        criterion: REQ-WORKBENCH-015#criterion.declaration-runtime-evidence
        covers:
        - FEAT-WORKBENCH-SPEC-DETAIL-001#binding.detail-workspace/target.detail-browser-workspace
        runner: { runner: cargo-test, arguments: { package: syu-workbench-server, test: tests::workbench_http_projection_readiness_and_esm_flow } }
      - kind: verifies
        criterion: REQ-WORKBENCH-015#criterion.canonical-detail-trace
        covers:
        - FEAT-WORKBENCH-SPEC-DETAIL-001#binding.detail-workspace/target.detail-browser-workspace
