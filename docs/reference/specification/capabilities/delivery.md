...
- **id**: FEAT-DELIVERY-001
  ...
  - **summary**: Persist completion attempts under an exact plan-and-slice identity, retain lifecycle proofs, and finalize complete work safely.
  - **status**: implemented
  - **bindings**:
    - **id**: implementation
      - **role**: implementation
...
- **id**: FEAT-AGENT-001
  ...
  - **summary**: Provide provider-neutral context, preflight-checked Modify/Add/Remove target writes, and append-only agent evidence.
  - **status**: implemented
  - **bindings**:
    - **id**: implementation
      - **role**: implementation
      - **facet**: scoped-agent
      - **responsibility**: Bind every agent lifecycle write and expansion request to one approved plan slice.
      - **owns**:
        - **id**: agent-module
          - **adapter**: rust
    ...
    - **id**: verification
      - **role**: verification
      - **facet**: scoped-agent
      - **responsibility**: Reject unrelated writes, prove lifecycle writes, and retain blocker and expansion evidence.
      - **targets**:
        - **id**: agent-http-test
          - **adapter**: rust
