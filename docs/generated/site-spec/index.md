...
- [Configuration / Workbench](config/workbench)
...
- [Workbench / Server](features/workbench/server)
- [Workbench / Shell](features/workbench/shell)
...
- [Core Workbench / Workbench](requirements/core/workbench)
