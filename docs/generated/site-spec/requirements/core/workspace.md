  ...
  - **tests**:
    - **rust**:
      ...
      - **file**: crates/syu-workbench-server/src/tests.rs
        - **symbols**:
          - request_plan_and_branch_scope_feed_page_models
