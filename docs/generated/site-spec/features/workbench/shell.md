...
- **id**: FEAT-WORKBENCH-001
  - **title**: Command-palette Workbench shell
  - **summary**: Open the Workbench around a command palette and goal-centered surface that launches request, goal, scope, assignment, and evidence actions without a fixed tab strip.
  - **status**: implemented
  - **linked_requirements**:
    - REQ-WORKBENCH-001
    - REQ-WORKBENCH-006
