...
- **id**: FEAT-WORKBENCH-007
  ...
  - **summary**: Serve the browser Workbench root and desktop shell from the same Rust-native Dioxus UI, Tailwind asset, typed action registry, and request, goal, assignment, and evidence model.
  - **status**: implemented
  - **linked_requirements**:
    - REQ-WORKBENCH-006
    - REQ-WORKBENCH-007
